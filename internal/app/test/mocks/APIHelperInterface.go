...
type mockConstructorTestingTNewAPIHelperInterface interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewAPIHelperInterface(t mockConstructorTestingTNewAPIHelperInterface) *APIHelperInterface {
