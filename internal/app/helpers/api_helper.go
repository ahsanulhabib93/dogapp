...
// CreateOmsSeller ...
func CreateOmsSeller(ctx context.Context, sellerParam *omsPb.SellerParams) *omsPb.SellerResponse {
	return getAPIHelperInstance().CreateOmsSeller(ctx, sellerParam)
}
